    ...
    <footer className="bg-black text-white py-12 md:py-16">
      <div className="container-width">
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-xl font-bold mb-6">Dheiver Santos</h3>
          ...
          <div className="flex items-center justify-center gap-6 mb-8">
            <a
              ...
              className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-yellow-600 transition-colors"
              aria-label="LinkedIn"
            >
